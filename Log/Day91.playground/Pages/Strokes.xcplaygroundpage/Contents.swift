...
let rendered = renderer.image { ctx in
    ...
    let smallcircle1 = CGRect(x: 400, y: 100, width: 200, height: 200)
    ctx.cgContext.addEllipse(in: smallcircle1)
    ctx.cgContext.drawPath(using: .fillStroke)
    
    let smallcircle2 = CGRect(x: 100, y: 400, width: 200, height: 200)
    ctx.cgContext.addEllipse(in: smallcircle2)
    ctx.cgContext.drawPath(using: .fillStroke)
    
    let smallcircle3 = CGRect(x: 700, y: 400, width: 200, height: 200)
    ctx.cgContext.addEllipse(in: smallcircle3)
    ctx.cgContext.drawPath(using: .fillStroke)
    
    let smallcircle4 = CGRect(x: 400, y: 700, width: 200, height: 200)
